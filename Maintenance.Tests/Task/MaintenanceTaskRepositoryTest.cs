...
namespace Maintenance.Tests.Task
{
    ...
    #region GetMaintenanceTask
        ...
        {
            var expectedTask = new MaintenanceTask() { Id = 5, VIN = "11233", Odometer = 5000, Date = DateTime.Now.AddMonths(-2), type = TaskType.GlowPlugReplacement };
        ...
        {
            var expectedTask = new MaintenanceTask() { Id = 778, VIN = "11233a", Odometer = 5000, Date = DateTime.Now.AddMonths(-2), type = TaskType.OilChange };
            _repo.InsertMaintenanceTask(expectedTask);
        ...
        public void GetMaintenanceTasks_ShouldReturnCorrectTask_GivenExistingVinButDifferentVinCase()
        {
            ...
            var expectedTask = new MaintenanceTask() { Id = 124, VIN = vin, Odometer = 5000, Date = DateTime.Now.AddMonths(-2), type = TaskType.OilChange };
            _repo.InsertMaintenanceTask(expectedTask);
        ...
        {
            var vin = "newVin11";
            var expectedTask1 = new MaintenanceTask() { Id = 99969, VIN = vin, type = TaskType.OilChange };
            _repo.InsertMaintenanceTask(expectedTask1);
            var expectedTask2 = new MaintenanceTask() { Id = 688886, VIN = vin, type = TaskType.GlowPlugReplacement };
